...
Prefer executable checks over prose. If a command can be encoded in CI or a repository script, do that and keep this document as a short map to the executable source of truth.
